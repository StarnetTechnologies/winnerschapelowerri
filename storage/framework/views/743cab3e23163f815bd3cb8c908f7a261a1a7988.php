...
<html lang="<?php echo e(app()->getLocale()); ?>">
	...
	<body style="background: #f7f7f7 url(<?php echo e(asset('storage/images/assets/the_new_church.jpg')); ?>)  center no-repeat; background-size: cover; background-attachment: fixed;overflow-x: hidden">
		<div id="app" style="background-color: rgba(0,0,0,.7);overflow-x:hidden">
