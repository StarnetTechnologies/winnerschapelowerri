<div id="services" style="background-image: url('<?php echo e(asset('storage/images/assets/black-and-white-cemetery-christ-208315.jpg')); ?>'); background-attachment: fixed" class="bg-image">

	<div class="text-center" style="background-color: rgba(0,0,0,.7)">
