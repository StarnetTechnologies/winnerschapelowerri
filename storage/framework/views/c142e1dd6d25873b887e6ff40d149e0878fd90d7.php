...
<div class="row align-items-center">
    <div class="col-md-7">
        <img src="<?php echo e(asset('storage/images/assets/mandate.jpg')); ?>" alt="The Mandate" style="width: 100%; height: auto; box-shadow: 10px 20px 20px rgba(0,0,0,0.4)">
    </div>
    <div class="col-md-5">
        <div style="background-color:#24292E; color: #fff; padding: 10px; border-radius: 0px 50px 0px 50px">
            <p>
