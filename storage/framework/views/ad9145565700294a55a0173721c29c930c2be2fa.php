        ...
        <div class="col-sm-8">
            ...
            <div id="single-post-container">
                <h2><?php echo e($post->title); ?></h2>
                 ...
                 <?php endif; ?>
                <p><img src="<?php echo e($PREF->pastor->dpUrl()); ?>" alt="<?php echo e($PREF->pastor->fullname); ?>" style="width: 70px; height: 70px; border-radius: 50%; border: 2px solid #fff">  <?php echo e($PREF->pastor->fullname); ?> <i class="fa fa-clock"></i> <?php echo e($post->created_at->diffForHumans()); ?> </p>
